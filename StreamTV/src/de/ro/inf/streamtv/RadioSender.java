...
/**
 * Subclass of Sender for handling the links of only radio channels
 * 
 * @author Nico Welles
 *
 */
public class RadioSender extends Sender {
	...
	/**
	 * Returns all the links of the channel with their bitrate in front. Array
	 * length is made variable through first using ArrayList, adding content,
	 * and then converting to Array. At the moment this is not necessary because
	 * of a lack of publicly acessible high quality radio stream links, but has
	 * been left in because it is still functional and allows reintroducing
	...
	public static String[] getLink(int channelNumber) {
		...
		// bitrate and the link itself to the ArrayList
