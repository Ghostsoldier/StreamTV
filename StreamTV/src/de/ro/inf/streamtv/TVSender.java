...
public class TVSender extends Sender {
	 ...
	 * Example:	[LD, http://daserste.../master.m3u8, HD, http://ard.../teststream.m3u8]
	 */
	static String[] link;
	
	/**
	 * Returns all the links of the channel with their resolution in front. Array length is made variable 
	 * through first using ArrayList, adding content, and then converting to Array. At the moment this is 
	 * not necessary because of a lack of publicly acessible HDTV stream links, but has been left in because
	 ...
	 * @return An array of links with their resolution in front, at the moment only the first link and resolution is used by the GUI
	 */
	public static String[] getLink(int channelNumber) {
		...
		//Goes through all <link> elements in the links.xml file, adding its resolution and the link itself to the ArrayList
